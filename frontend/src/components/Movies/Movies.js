    ...
    <>
      <Flex vertical>
        ...
        <div
          ...
          <div
            style={{
              marginLeft: "clamp(16px, 10%, 230px)",
              marginRight: "clamp(16px, 10%, 230px)",
              marginTop: "100px",
              display: "flex",
              flexDirection: "column",
            }}>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <span style={{ color: "#333", fontWeight: "bold", fontSize: 20 }}>
                Tìm kiếm phim trên Flickzy
              </span>
            ...
            <div className="movie-grid" key={currentPage}>
              {movies?.map((movie) => (
                <div
                  className={`movie-grid-item ${transitionState}`}
                  key={movie.id}>
